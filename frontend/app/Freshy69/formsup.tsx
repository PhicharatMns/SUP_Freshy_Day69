    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center w-full h-full z-50">
        ...
        <div className="grid grid-cols-3 gap-4 w-full max-w-2xl p-4">
          {Social.map((e, i) => {
            const buttonStyle = `w-full text-xl h-40 z-50 hover:scale-105 flex items-center justify-center rounded-[20px] font-bold text-white shadow-lg bg-gradient-to-tr ${e.gradient} animate-gentle-bounce transition-all duration-300 cursor-pointer`;
            return (
              <div
                onClick={e.popup}
